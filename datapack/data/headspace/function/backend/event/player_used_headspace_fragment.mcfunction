...
execute store success score @s hs.check.TeleportSuccess run function headspace:backend/tools/execute_with_uuid_storage/0 {function: "headspace:backend/teleport/fragment/headspace/use", target: "@s"}
...
execute if score @s hs.check.TeleportSuccess matches 0 run function headspace:backend/teleport/default/headspace/use