...
execute if score @s hs.check.LoadedChunk matches 1 if score @s hs.check.TeleportSuccess matches 0 run function headspace:backend/teleport/default/otherworld/use
